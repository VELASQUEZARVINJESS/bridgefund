			...
			<div class="col-lg-8 offset-lg-2">
				<div class="form-group row">
					<div class="col-md-6 offset-md-3" style="position: relative;">
						<video id="video" width="400" height="300" style="border:1px dashed; display: none;"></video>
						<div id="frame" style="border: 2px dashed #000; width: 300px; height: 300px;position: absolute;top: 0;left: 50px; display: none;"></div>
						<img id="photo" style="margin-left:3em;margin-bottom:0.3em;width:300px; height:300px;">
			...
			<form class="form-horizontal applyloan col-lg-8 offset-lg-2" method="post" action="#">
				...
				<div class="form-group row">
					...
					<div class="col-sm-8 col-md-4">
                        <input type="hidden" id="applicant" name="applicant" class="form-control" readonly>
				...
				<div class="form-group row">
					...
					<div class="col-sm-8 col-md-4">
						<input type="number" name="processingfee" id="processingfee" class="form-control" value="150" readonly>
					</div>
				</div>
				<div class="form-group row">
					<label for="notaryfee" class="col-sm-4 col-md-4 col-form-label">Notarial Fee</label>
					<div class="col-sm-8 col-md-4">
						<input type="number" name="notaryfee" id="notaryfee" class="form-control" value="100" readonly>
					</div>
				</div>
