					...
					<div class="row">
						...
						<div class="col-sm">
							<div class="form-group">
								...
								<select class="form-control select2bs4" name="marital">
					...
					<div class="row">
						<div class="col-sm">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="baddress" name="baddress" placeholder="House #, Street, Barangay">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm">
							<div class="form-group">
								...
								<select class="form-control select2bs4" name="province"></select>
							</div>
						</div>
						<div class="col-sm">
							<div class="form-group">
								<label for="city">City / Town</label>
								<select class="form-control select2bs4" name="city"></select>
							</div>
						</div>
						<div class="col-sm">
							<div class="form-group">
					...
					<div class="row">
						...
						<div class="col-sm">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="smonthly" name="smonthly">
							</div>
						</div>
						<div class="col-sm">
							<div class="form-group">
								<label for="stakehome">Take Home Pay</label>
								<input type="text" class="form-control" id="stakehome" name="stakehome">
							</div>
						</div>
					</div>
					<div class="row">
