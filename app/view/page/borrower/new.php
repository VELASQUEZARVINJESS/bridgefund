			...
			<div class="row">
				...
				<div class="col-sm">
					<div class="form-group">
						...
						<input type="email" class="form-control" id="mname" placeholder="Middle Name">
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-sm">
					<div class="form-group">
						...
						<input type="email" class="form-control" id="caddress">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm">
					...
					<label>HR Manager</label>
						<input type="email" class="form-control" id="hmanager">
					</div>
				</div>
				<div class="col-sm">
					<div class="form-group">
					<label>HR Contact Number</label>
						<input type="email" class="form-control" id="hcontact">
					</div>
				</div>
				<div class="col-sm">
					<div class="form-group">
