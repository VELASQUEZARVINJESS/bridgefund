<div class="modal fade" id="edit_payment" tabindex="-1" role="dialog" aria-labelledby="editpaymentModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="editpaymentModalLabel">Edit Repayment<span></span></h5>
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-4"></div>
					<div class="col"><button class="btn btn-success btn-block updatePayment">Update</button></div>
				</div><br>
			</div>
