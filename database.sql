...
CREATE TABLE IF NOT EXISTS `accounts` (
	id TINYINT(2) UNSIGNED PRIMARY KEY AUTO_INCREMENT,
	atype CHAR(32) NOT NULL,
	balance DECIMAL(9,2) NOT NULL,
	initial_balance DECIMAL(9,2) NOT NULL,
	update_by CHAR(64) NOT NULL,
	date_created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	date_updated TIMESTAMP NULL ON UPDATE CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS `borrower_notes`(
	...
	note VARCHAR(25000) NOT NULL,
	added_by CHAR(64) NOT NULL,
	date_created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	active TINYINT(1) NOT NULL DEFAULT 1
);
...
ALTER TABLE `expenses` ADD `active` TINYINT(1) NOT NULL DEFAULT '1' AFTER `editby`;

CREATE TABLE IF NOT EXISTS deposit (
	id INT(9) UNSIGNED PRIMARY KEY AUTO_INCREMENT,
	amount DECIMAL(7,2) NOT NULL,
	reference CHAR(250) NOT NULL,
	transdate DATE NOT NULL,
	date_created TIMESTAMP NOT NULL DEFAULT current_timestamp(),
	addby char(64) NOT NULL,
	date_updated TIMESTAMP NULL DEFAULT NULL ON UPDATE current_timestamp(),
	editby CHAR(64) DEFAULT NULL,
	active TINYINT(1) NOT NULL DEFAULT 1
